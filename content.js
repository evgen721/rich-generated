                        ...
                        <div class="media-controls-container">
                            ...
                            <div class="controls-column">
                                ...
                                <div class="image-link-container">
                                    <input type="text" placeholder="Гиперссылка на картинке (необязательно)" class="image-link-input">
                                </div>
                            </div>
                        </div>
                    </div>
...
function addImageRow(button) {
    ...
    imageBlock.innerHTML = `
        ...
        <input type="text" placeholder="Гиперссылка на картинке (необяз.)" class="image-link-input">
